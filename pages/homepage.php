...
<div class="hero">
  <div class="hero__content reveal">
    ...
    <h1 class="big-text" style="color: white">Il team di sviluppo ha sempre seguito con particolare interesse l’evoluzione tecnologica e il sopravvento
      di nuove tendenze permettendo così la realizzazione di un sito responsivo ed intuitivo attraverso il quale l’utente
      può considerare numerosi aspetti che spesso vengono ignorati quando si pianifica una vacanza,
      tra cui: eventi ed usanze locali, clima, costo della vita, qualità della vita, attrazioni e molto altro ancora.</h1>
...
<div class="mt-1">
  ...
  <div class="main-carousel hero__content flickity-enabled is-draggable" data-flickity='{ "cellAlign": "left","contain": true }'>
    <div class="carousel-cell">
      <div class="carousel-cell__content meta1 zoom">
          <h5>AI Bagawat</h5>
      </div>
    </div>
    <div class="carousel-cell">
      <div class="carousel-cell__content meta2 zoom">
          <h5>AI Bagawat</h5>
      </div>
    </div>
    <div class="carousel-cell">
      <div class="carousel-cell__content meta3 zoom">
        <h5>AI Bagawat</h5>
      </div>
    </div>
    <div class="carousel-cell">
      <div class="carousel-cell__content meta4 zoom">
        <h5>AI Bagawat</h5>
      </div>
    </div>
    <div class="carousel-cell">
      <div class="carousel-cell__content meta5 zoom">
        <h5>AI Bagawat</h5>
      </div>
    </div>
    <div class="carousel-cell">
      <div class="carousel-cell__content meta6 zoom">
        <h5>AI Bagawat</h5>
      </div>
    </div>
  </div>
...
<div class="mt-1 mb-1">
  ...
  <div class="main-carousel hero__content" data-flickity='{ "cellAlign": "left", "contain": true }'>
    <div class="carousel-cell">
      <div class="carousel-cell__content1 pacchetto1 zoom">
        <h5>Caraibi</h5>
      </div>
    </div>
    <div class="carousel-cell">
      <div class="carousel-cell__content1 pacchetto2 zoom">
        <h5>GRECIA + MYKONOS</h5>
      </div>
    </div>
    <div class="carousel-cell">
      <div class="carousel-cell__content1 pacchetto3 zoom">
        <h5>Creta</h5>
      </div>
    </div>
    <div class="carousel-cell">
      <div class="carousel-cell__content1 pacchetto4 zoom">
        <h5>Sharm el Sheikh</h5>
      </div>
    </div>
    <div class="carousel-cell">
      <div class="carousel-cell__content1 pacchetto5 zoom">
        <h5>Tenerife</h5>
      </div>
    </div>
    <div class="carousel-cell">
      <div class="carousel-cell__content1 pacchetto6 zoom">
        text
      </div>
    </div>
  </div>
